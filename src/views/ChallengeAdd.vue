...
const addChallenge = async () => {
    await axios.post("/api/challenge/add",
    {
  ...
  Swal.fire("Successfully added Challenge");
      ...
      <div class="body">
        <div class="max-w-8xl mx-auto px-4 mt-6">
          <div class="items-center">
            <h1 class="inline-block text-4xl font-semibold text-emerald-700 tracking-tight">AddInG nEw ChaLLenGe</h1>
            ...
            <form class="w-full max-w-lg mt-10" @submit.prevent="addChallenge">
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-password">
                            Title
                        </label>
                        <input v-model="nama_tantangan" class="appearance-none block w-full bg-gray-200-50  text-gray-700 border border-emerald-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"id="grid-first-name" type="text" placeholder="Learn Python">
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input v-model="tanggal_mulai" class="appearance-none block w-full bg-gray-200-50  text-gray-700 border border-emerald-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"id="grid-first-name" type="date" placeholder="Sad">
                    </div>
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-first-name">
                            Finish Date
                        </label>
                        <input v-model="tanggal_berakhir" class="appearance-none block w-full bg-gray-200-50  text-gray-700 border border-emerald-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"id="grid-first-name" type="date" placeholder="#ffffff">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <textarea v-model="deskripsi" class="resize rounded-sm appearance-none block w-full bg-gray-200-50 text-gray-700 border border-emerald-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" ></textarea>
                        <p class="text-xs text-gray-200-50">Drag the corner of the content box to resize it.</p>
                    </div>
                </div>
                <div class="md:w-2/3">
                    <button class="shadow bg-emerald-700 hover:bg-emerald-600 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit">
                        Save
                    </button>
                </div>
            </form>
