      ...
      <div class="body">
        <div class="max-w-8xl mx-auto px-4 mt-6">
          <div class="items-center">
            <h1 class="inline-block text-4xl uppercase l font-semibold text-emerald-700 tracking-tight">MY JOURNAL</h1>

            <p class="mt-2">
                It's not that bad to write your thoughts and feelings onto digital paper; it helps in processing emotions and gaining clarity. It can externalize internal struggles, foster self-awareness, and facilitate connection with others for enhanced coping and well-being.
            </p>

            <RouterLink to="/journal/add">
              <Button class="bg-emerald-700 px-3 py-2 mt-5 rounded-md hover:-translate-y-1 duration-200">
                <p class="text-white font-semibold" >Add a Journal</p>
              </Button>
            </RouterLink>

            <div class="grid w-full sm:grid-cols-4 xs:grid-cols-4 gap-4 mt-10">
                <!-- MAP -->
