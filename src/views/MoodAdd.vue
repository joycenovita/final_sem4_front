...
const addMood = async () => {
  ...
  Swal.fire("Successfully added Mood");
  router.push("/mood");
};
      ...
      <div class="body">
        <div class="max-w-8xl mx-auto px-4 mt-6">
          <div class="items-center">
            <h1 class="inline-block text-4xl font-semibold text-emerald-700 tracking-tight">AddInG nEw MoOd</h1>
            
            <p class="mt-2">
                Add new colors to help analyze yourself. It can enhance the process. Describe how you feel today and make sure to choose a color to represent it.
            </p>
            ...
            <form class="w-full max-w-lg mt-10"  @submit.prevent="addMood">
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-first-name">
                            Mood Title
                        </label>
                        <input v-model="nama_mood" class="appearance-none block w-full bg-gray-200-50  text-gray-700 border border-emerald-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"id="grid-first-name" type="text" placeholder="Sad">
                    </div>
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-first-name">
                            Mood Color
                        </label>
                        <input v-model="warna" class="appearance-none block w-full bg-gray-200-50  text-gray-700 border border-emerald-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"id="grid-first-name" type="text" placeholder="#ffffff">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <textarea v-model="keterangan" class="resize rounded-sm appearance-none block w-full bg-gray-200-50 text-gray-700 border border-emerald-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" placeholder="I am feeling empty" ></textarea>
