...
const addResource = async () => {
    await axios.post("/api/resource/add",
    {
      judul: judul.value,
  ...
  Swal.fire("Successfully added Resource");
      ...
      <div>
        <div class="max-w-8xl mx-auto px-4 mt-6">
          <div class="items-center">
            <h1 class="inline-block text-4xl font-semibold text-emerald-700 tracking-tight">AddInG nEw ReSoURCes</h1>
            
            <p class="mt-2">
                Adding motivational quotes to your resource can provide that extra boost of inspiration when you need it most.
            </p>
            ...
            <form class="w-full max-w-lg mt-10" @submit.prevent="addResource">
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-password">
                            Title
                        </label>
                        <input v-model="judul" class="appearance-none block w-full bg-gray-200-50  text-gray-700 border border-emerald-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"id="grid-first-name" type="text" placeholder="3 Things to do if you are bored">
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <input v-model="kategori" class="appearance-none block w-full bg-gray-200-50  text-gray-700 border border-emerald-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"id="grid-first-name" type="text" placeholder="Motivational">
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <input v-model="tautan" class="appearance-none block w-full bg-gray-200-50  text-gray-700 border border-emerald-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"id="grid-first-name" type="text" placeholder="https://www.pinterest.com/">
