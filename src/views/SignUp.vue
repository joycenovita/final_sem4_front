    ...
    <div class="w-full max-w-md">
      <form class="px-8 pt-6 pb-4 mb-4" @submit.prevent="createUser">
        ...
        <div class="mt-4">
          ...
          <input
            v-model="first_name"
            class="shadow appearance-none border border-slate-600 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
          />
        </div>
        <div class="mt-3">
        ...
        <div class="mt-4">
          <button
            class="bg-emerald-700 hover:bg-emerald-600 text-white font-bold w-full py-2 px-4 rounded focus:outline-none focus:shadow-outline"
            type="submit"
          >
            Create
          </button>
